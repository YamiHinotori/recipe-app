        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-10">
          ...
          <div className="mt-6 space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-gray-800">Geräte-Synchronisation</p>
                <p className="text-xs text-gray-600">Greife von überall auf deine Rezepte zu</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-gray-800">Geteilte Einkaufsliste</p>
                <p className="text-xs text-gray-600">Arbeitet zusammen in Echtzeit</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-gray-800">Automatische Backups</p>
                <p className="text-xs text-gray-600">Nie wieder Daten verlieren</p>
              </div>
            </div>
          </div>
        </div>
